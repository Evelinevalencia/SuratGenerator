  ...
  <div class="row">
    <div class="col-9">
      ...
      <div class="col-12 d-flex my-3 justify-content-end">
        <a href="<?php echo e(url('ttd/create/'.$surat->id_surat)); ?>" class="btn btnSolid buRed me-5"><i class="fa-regular fa-pen-to-square me-1"></i>Tanda Tangan</a>
        <a href="<?php echo e(url('reviewsurat')); ?>" class="btn btnSolid buBlue me-2">Tutup</a>
        <a href="<?php echo e(url('reviewsurat')); ?>" class="btn btnSolid buGreen">Simpan</a>
      </div>
    </div>
    <div class="col-3">
      <div class="sideSek">
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MatanaUniversityAdministration\resources\views/Yoyo/tampilanview.blade.php ENDPATH**/ ?>