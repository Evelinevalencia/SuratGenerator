...
<div class="container">
  <div class="row">
    <div class="col-3">
      ...
      <a href="<?php echo e(url('buatsurat')); ?>" type="button" class="btn w-100 send-btn">
      ...
      <div class="mb-5">
        ...
        <div class="d-flex">
          <div style="margin-right: 5%" class="text-center">
            <h2 class="fw-bold staRed"><?php echo e($tunggu); ?></h2>
        ...
        <div class="suratTable">
          <div style="border: 3px solid black; margin-bottom: 1%;" class="rounded-3">
            <form method="GET" action="dashboard" class="d-flex">
              <input class="form-control me-2" type="search" name="filter" placeholder="Search" value="<?php echo e(old('filter')); ?>">
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MatanaUniversityAdministration\resources\views/Yoyo/homepage.blade.php ENDPATH**/ ?>