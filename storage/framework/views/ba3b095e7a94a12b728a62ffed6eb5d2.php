...
<Form method="POST" action=" /reviewsurat/<?php echo e($surat->id_surat); ?> ">
  ...
  <div class="container">
    ...
    <input type="email" name="email" value="<?php echo e($surat->email); ?>" class="form-control yth">
    <div class="row">
      <div class="col-9 p-5 border border-secondary boxBorder">
        <h3 class="fs-5 fw-bold">Judul Surat</h3>
        <input type="text" name="nama_surat" value="<?php echo e($surat->nama_surat); ?>" class="form-control yth">
        <input type="text" style="display:none;" value="<?php echo e($surat->id_template); ?>" name="id_template" class="form-control yth">
    ...
    <div class="row">
      <div class="col-9 d-flex my-3 justify-content-end">
        <a href="<?php echo e(url('reviewsurat')); ?>" class="btn btnSolid buRed me-2">Batal</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MatanaUniversityAdministration\resources\views/Nico/editsurat.blade.php ENDPATH**/ ?>