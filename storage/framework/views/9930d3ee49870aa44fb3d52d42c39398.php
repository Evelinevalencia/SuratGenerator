  ...
  <div class="row">
    <div class="col-9">
      ...
      <div class="col-12 d-flex my-3 justify-content-end">
        ...
        <a href="<?php echo e(url('reviewsurat')); ?>" class="btn btnSolid buBlue me-2">Tutup</a>
    ...
    <div class="col-3">
      <div class="sideSek">
        ...
        <a type="button" style="border: 1px solid red" class="btn w-100 down-btn" href="<?php echo e(url('tambahkomentar/create/'.$surat->id_surat)); ?>">
          <div class="d-flex justify-content-center">
        ...
        <div class="sideSquare">
          <div class="squHead px-4 py-2 rounded-top">
            <h6><?php echo e($akun->name); ?></h6>
          </div>
          <div class="squDesc px-4 py-2 ">
            <form method="POST" action="<?php echo e(URL::to('tambahkomentar')); ?>">
              <?php echo csrf_field(); ?>
              <textarea name="komentar" class="fs-6 fw-bold"></textarea>
              <input type="text" name="iduser" value="<?php echo e($akun->id); ?>" style="display:none;" />
              <input type="text" style="display:none;" name="idsurat" value="<?php echo e($surat->id_surat); ?>" />
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MatanaUniversityAdministration\resources\views/Yoyo/promptkomentar.blade.php ENDPATH**/ ?>