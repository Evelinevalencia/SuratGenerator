            ...
            <div class="mb-5">
                ...
                <div class="d-flex justify-content-between">
                    <div class="text-center">
                        <h2 class="fw-bold staGreen">{{$diterima}}</h2>
                        <h6>Surat Diterima</h6>
                    </div>
                    <div class="text-center">
                        <h2 class="fw-bold staRed">{{$ditolak}}</h2>
                        <h6>Surat Ditolak</h6>
                    </div>
                    <div class="text-center">
                        <h2 class="fw-bold staGrey">{{$tunggu}}</h2>
                ...
                <div class="suratTable">
                    <div class="">
                        <form method="GET" action="dashboard" class="d-flex">
                            <input class="form-control me-2" type="search" name="filter" placeholder="Search" aria-label="filter" value="{{ old('filter') }}">
